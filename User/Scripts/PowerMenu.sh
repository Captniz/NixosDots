...
# Taken from : https://github.com/jluttine/rofi-power-menu
# I needed to edit the hibernat option
...
all=(shutdown reboot suspend hybrid-sleep logout lockscreen)
...
texts[hybrid-sleep]="hybrid sleep"
texts[reboot]="reboot"
...
actions[hybrid-sleep]="systemctl hybrid-sleep"
