  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bindde = [
        ...
        "SUPER, F5, Brightness down,exec, brightnessctl s 5%- && sh ${userSettings.scriptsPath}/NotifyBrightness.sh && qs ipc call brightness update"
        "SUPER, F6, Brightness up,exec, brightnessctl s +5% && sh ${userSettings.scriptsPath}/NotifyBrightness.sh && qs ipc call brightness update"
